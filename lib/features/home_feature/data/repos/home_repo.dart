...
abstract class HomeRepo {
  Future<Either<ServerFailure , SliderModel>> getSliderData();
  Future<Either<ServerFailure , BestSellerModel>> getBestSellerData();
  Future<Either<ServerFailure , CategoryModel>> getCategoryData();
  Future<Either<ServerFailure , NewArrivalModel>> getNewArrivalData();
}